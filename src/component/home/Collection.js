        ...
        <div className='flex flex-col  justify-center items-center'>
            ...
            <div className='lg:flex xl:w-[66%] xl:h-[300px] '>
                <div className='bg-white border xl:w-9/12  p-8'>
                    ...
                    <p className='text-xl font-Raleway text-justify'>Making seating more comfortable, while preparing your home for the summer with our new range of bright colors</p>
